// Performance bench for the TypeScript port (runs against the built
// dist/StructUtility.js). Emits one JSON line per build/bench/README.md.
// All diagnostics go to stderr so stdout carries only the JSON contract line.
'use strict'
runBench('typescript', require('../dist/StructUtility'), 'node ' + process.version)

// Shared node bench body — the javascript port uses an identical function,
